...
\
where g~s~ is the conductance to CO~2~. We now have two equations for A~n~. The 'demand function' is given by Eq. 1, and the 'supply function' in Eq. 3. At steady state these two equation should be equal, which can be graphically shown as in Fig. 1b (cf. [@farquhar1982]).  
