...
"Simulate C3 photosynthesis and transpiration with the coupled leaf gas exchange model. Also simulates the FvC model when either C~i~ or g~s~ is given as input. For C4 photosynthesis, see `AciC4`",
...
**Figure 2**. Standard output from the `fitaci` function. A~n~ is the net photosynthetic rate, C~i~ the intercellular CO~2~ concentration. Symbols are measurements, the black line the fitted FvC model of photosynthesis. Colored lines indicate the two photosynthesis rates in the FvC model.
